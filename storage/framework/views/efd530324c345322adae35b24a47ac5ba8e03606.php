    ...
    <div class="nav-right col pull-right right-menu p-0">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown p-0">
          ...
          <button type="submit" class="btn btn-primary-light"><i data-feather="log-out"></i>Log Out</button>
...
<?php /**PATH /Users/angek/Downloads/vihoadmin-10/vihoadmin-10/viho_html_laravel/Viho-Laravel-8/theme/resources/views/layouts/admin/partials/header.blade.php ENDPATH**/ ?>